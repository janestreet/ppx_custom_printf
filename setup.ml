(* OASIS_START *)
(* DO NOT EDIT (digest: e55fbfd42abc68d069cc32440e35d147) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_parent = Some "ppx_custom_printf";
                      lib_findlib_name = Some "format-lifter";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "t\b^?\213Y\232\200\231R\027\b\027\164\190\019";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
